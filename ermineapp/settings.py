"""
Django settings for ermineapp project.
...
SECRET_KEY = 'django-insecure-0ihdzqww7ih$p!6@^!s_o0u&p=6&ect2)-8fg!es48m116*laq'
...
WSGI_APPLICATION = 'ermineapp.wsgi.application'
